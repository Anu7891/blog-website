export const APP_NAME = "Crypto Blogs";

export const API_BASE_URL ="https://monil-news-letter-crud.vercel.app/article";
export const CATEGORIES_URL = "https://monil-news-letter-crud.vercel.app/categories";
export const SUBCATEGORIES_URL ="https://monil-news-letter-crud.vercel.app/article/categoryList";
...
export const HAMBURGER_ICON = "images/hamburger.png";
export const CLOSE_ICON = "images/close-icon.png";
